				...
				<div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: false, lg: true}" data-kt-sticky-name="app-header-sticky" data-kt-sticky-offset="{default: false, lg: '300px'}">
					...
					<div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
							<a href="index.html">
								<img alt="Logo" src="{{ asset('assets/media/logos/default-dark.svg')}}" class="h-25px d-none d-lg-inline" />
								<img alt="Logo" src="{{ asset('assets/media/logos/default-small-dark.svg')}}" class="h-25px d-inline d-lg-none" />
							</a>
						</div>
						<!--end::Logo-->
						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
								...
								<div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
										...
										<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="https://preview.keenthemes.com/metronic8/demo45/layout-builder.html" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
													<span class="menu-icon">
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item align-items-stretch ms-1 ms-lg-3">
									...
									<div id="kt_header_search" class="header-search d-flex align-items-stretch" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-overflow="false" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end">
										...
										<div class="d-flex align-items-center" data-kt-search-element="toggle" id="kt_header_search_toggle">
											<div class="btn btn-icon btn-icon-white btn-custom btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
								...
								<div class="app-navbar-item ms-1 ms-lg-3">
									<!--begin::Drawer toggle-->
									<div class="btn btn-icon btn-icon-white btn-custom btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" id="kt_activities_toggle">
								...
								<div class="app-navbar-item ms-1 ms-lg-3">
									<!--begin::Menu- wrapper-->
									<div class="btn btn-icon btn-icon-white btn-custom btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
								...
								<div class="app-navbar-item">
									<a href="#" class="btn btn-sm btn-success d-flex flex-center ms-6 ps-3 pe-4 h-35px" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
						...
						<div id="kt_app_hero_container" class="app-container container-xxl d-flex">
							...
							<div class="d-flex flex-stack flex-wrap flex-lg-nowrap flex-row-fluid gap-4 gap-lg-10 mb-10">
								...
								<div class="d-flex align-items-center me-3">
									...
									<!--begin::Title-->
									<h1 class="page-heading d-flex text-white fw-bolder fs-2 flex-column justify-content-center my-0">CodeLab - Devs Team 
									<!--begin::Description-->
						...
						<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
							...
							<div class="d-flex flex-column flex-column-fluid">
								...
								<div id="kt_app_content" class="app-content">
									...
									<div id="kt_app_toolbar" class="app-toolbar d-flex flex-column py-6">
										<!--begin::Content menu-->
										<div class="app-content-menu menu menu-rounded bg-gray-200 menu-state-bg flex-wrap fs-5 fw-bold mt-n15 pt-5 pb-0 mb-7 gap-1">
											<!--begin::Menu item-->
											...
											<!--begin::Menu item-->
											<div class="menu-item m-0 p-0">
												<a class="menu-link py-3 px-4" href="apps/projects/list.html">
													<span class="menu-title">Projects</span>
												</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item m-0 p-0">
												<a class="menu-link py-3 px-4" href="apps/subscriptions/list.html">
													<span class="menu-title">Subscriptions</span>
												</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item m-0 p-0">
												<a class="menu-link py-3 px-4" href="apps/file-manager/folders.html">
													<span class="menu-title">Files</span>
												</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item m-0 p-0">
												<a class="menu-link py-3 px-4" href="apps/support-center/contact.html">
											...
											<!--begin::Menu item-->
											<div class="menu-item m-0 p-0">
												<a class="menu-link py-3 px-4" href="apps/customers/list.html">
													<span class="menu-title">Customers</span>
												</a>
											</div>
											<!--end::Menu item-->
										...
										<div class="app-toolbar-wrapper d-flex align-items-center flex-stack flex-wrap gap-2 py-4 w-100">
											...
											<div class="page-title d-flex flex-column justify-content-center gap-2 me-3">
												<!--begin::Title-->
												<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-1 m-0">Account Summary 
												<!--begin::Description-->
											...
											<div class="d-flex align-items-center gap-2 gap-lg-3">
												<a href="#" class="btn btn-flex btn-outline btn-gray-700 btn-active-color-primary bg-body h-40px fs-7 fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_view_users">Add Member</a>
							...
							<div id="kt_app_footer" class="app-footer d-flex flex-column flex-md-row align-items-center flex-center flex-md-stack py-2 py-lg-4">
								...
								<div class="text-gray-900 order-2 order-md-1">
									<span class="text-gray-500 fw-semibold me-1">2024&copy;</span>
									<a href="https://keenthemes.com" target="_blank" class="text-gray-500 text-hover-primary">Keenthemes</a>
								</div>
								<!--end::Copyright-->
								<!--begin::Menu-->
